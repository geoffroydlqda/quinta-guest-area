      ...
      <div className="max-w-5xl mx-auto space-y-6">
              ...
              onClick={async (e) => {
                ...
                try {
                  await downloadRoomMapPdf(
                    roomsArrangement,
                    buildMapEntries(),
                    // Guest : le plan seul — les infos d'intendance (typologie,
                    // jogos de cama, notes) sont réservées au PDF Housekeeping.
        ...
        <div className="grid gap-2 md:grid-cols-2">
          <div className="rounded-xl bg-muted/50 border border-border/70 px-3.5 py-2.5 flex items-start gap-2">
            <Crown className="w-4 h-4 text-[#7E8F53] flex-shrink-0 mt-0.5" />
            <p className="text-xs text-muted-foreground leading-snug">
              <span className="font-medium text-foreground">Rooms 1 & 6:</span> fixed King beds, en-suite.
            </p>
          </div>
          <div className="rounded-xl bg-muted/50 border border-border/70 px-3.5 py-2.5 flex items-start gap-2">
            <Info className="w-4 h-4 text-[#7E8F53] flex-shrink-0 mt-0.5" />
            <p className="text-xs text-muted-foreground leading-snug">
