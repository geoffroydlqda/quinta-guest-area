...
import { ArrowLeft, ArrowRight, Crown, Home, ZoomIn } from 'lucide-react';
        ...
        <div className="rounded-xl bg-primary/10 border-2 border-primary/30 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Upstairs, accessed through the kitchen. Their shared bathroom is slightly smaller. These rooms are often reserved for facilitators and have the best view.
              </p>
            </div>
          </div>
        </div>
